  ...
  const PRODUCT_PROPS: Array<GetProductProps> = [
    {
      ...
      element: (
        <ModalHeroShowProducts title="Eletrônicos" product={prodElectronics} />
      ),
    },
    {
      title: 'Orquídeas',
    ...
    },
    {
      ...
      element: (
        <ModalHeroShowProducts title="Automotivo" product={prodAutomotive} />
      ),
    },
    {
      title: 'Papelaria',
      ...
      element: (
        <ModalHeroShowProducts title="Papelaria" product={prodStationeryShop} />
      ),
    },
    {
      title: 'Tecnologia',
      ...
      element: (
        <ModalHeroShowProducts title="Tecnologia" product={prodTechnology} />
      ),
    },
  ]
